...
function handleChange(){
    ...
    return(
        <div className="homepage" >
            <img src="https://images.unsplash.com/photo-1543353071-873f17a7a088?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" width="100%" height="100%" className="landingBackground" alt=""/>
            ...
            <div className="restimage">
                <Link to="/restaurant"><img src={data.image ? data.image : placeholder.image} width="100%" height="100%" onClick={handleChange} alt=" "/></Link>
                </div>
